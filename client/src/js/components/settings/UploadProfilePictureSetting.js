...
*/
class UploadProfilePictureSetting extends Component {
    constructor(props) {
        super(props);
            ...
            <div>
                ...
                <label htmlFor="profilePic-file">
                    <ListItem button>
                        ...
                        <ListItemText primary="Profile Picture" secondary="An image of you with your car" />
                    </ListItem>
                </label>
                <Dialog open={this.state.successDialog} onClose={this.handleClose}>
                    ...
                    <DialogContent>
                        <DialogContentText>
                            You have successfully uploaded a new profile picture. The image will be verified by our team.
                        </DialogContentText>
                    </DialogContent>
                    <DialogActions>
...
export default UploadProfilePictureSetting;