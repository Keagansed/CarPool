...
/*
* Purpose: Popup modal that allows you to choose a new profile picture for your account
*/
class EditProfilePictureSetting extends Component {
    ...
    */
    ...
    /*
    * Purpose: API call to the backend that updates the users profile picture and returns whether or not
    ...
    */
    upload() {
        ...
        xhr.open('POST', ServerURL + '/api/account/uploadFile/profilePicture?token=' + this.props.token, true);
                ...
                <div className="modal-dialog" role="document">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <div className="row">
                                <input type="file" onChange={this.handleFileChange.bind(this)} className="inputfile" id="profilePictureFile"/>
                                <label htmlFor="profilePictureFile" className="btn btn-primary mx-auto width-15rem brad-2rem mbottom-1rem bg-aqua txt-purple fw-bold">Choose a file</label> 
                            </div>
                            <div className="row">
