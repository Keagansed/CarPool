                ...
                <div className="modal-dialog" role="document">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <div className="row">
                                <input type="file" onChange={this.handleFileChange.bind(this)} className="inputfile" id="carFile"/>
                                <label htmlFor="carFile" className="btn btn-primary mx-auto width-15rem brad-2rem mbottom-1rem bg-aqua txt-purple fw-bold">Choose a file</label> 
                            </div>
                            <div className="row">
...
export default UploadCarPictureSetting;