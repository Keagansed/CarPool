...
/*
* Purpose: Popup modal that allows you to upload a car registration picture for your account
*/
class UploadCarRegistrationSetting extends Component {
    ...
    */
    ...
    /*
    * Purpose: API call to the backend that updates the users car registration picture and returns whether or not
                ...
                <div className="modal-dialog" role="document">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <div className="row">
                                <input type="file" onChange={this.handleFileChange.bind(this)} className="inputfile" id="registrationFile"/>
                                <label htmlFor="registrationFile" className="btn btn-primary mx-auto width-15rem brad-2rem mbottom-1rem bg-aqua txt-purple fw-bold">Choose a file</label> 
                            </div>
                            <div className="row">
