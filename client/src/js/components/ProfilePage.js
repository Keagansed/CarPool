						...
						<div className="col-md-12 col-12 profileHeader">
							<div className="row w-100 m-0 h-100 py-3">
								<div className="m-0 p-0 col-md-12" id="colHeaderImage">
									<img className="d-block mx-auto rounded-circle border-white p-1 bg-primary" src={profilePicture} height="120" width="120" id="imgProfilePic"/> 
								</div>
									...
									<div className="row">
											...
											<div className="row">
												<div className="col-12 text-center py-0">
													<p className="text-primary m-0 text-center" id="pRatingAvg">
														<font color="#140d4f" className="text-primary">4.3</font>
													</p>
												</div>
										...
										<div className="thin-border-sides col-4 col-md-4">
											<p className="text-primary text-center m-0" id="pNumTrips">
												<font color="#140d4f" className="text-primary">34</font>
											</p>
											<p className="text-white text-center m-0" id="pNumTripsLabel">Total Trips</p>
										</div>
										<div className="col-4 col-md-4">
											<p className="text-primary text-center m-0" id="pTrust">
												<font color="#140d4f" className="text-primary">3/5</font>
											</p>
									...
									<a href="#" className="list-group-item list-group-item-action flex-column align-items-start bg-info text-white m-0 py-1">
										<div className="row p-0">
											<div className="col-3 col-md-3 text-center p-0">
												<img className="d-block rounded-circle bg-primary p-1 border img-fluid m-2 mx-auto" src={profilePicture} id="imgProfilePic" width="80" height="80"/> 
											</div>
											<div className="col-6 col-md-6 p-2">
												<div className="row">
													...
													<div className="col-md-12 col-12 p-0">
														<p className="m-0 text-muted small-text">10/05/2018</p>
													</div>
													<div className="col-md-12 col-12 p-0">
														<p className="m-0 small-text text-secondary">Pleasant company, he kept me entertained </p>
													</div>
												</div>
											</div>
											<div className="mr-auto col-3 col-md-3">
												<img className="d-block rounded-circle p-1 img-fluid my-3 float-right" src={infoIcon} id="imgProfilePic" width="50" height="50"/> 
											</div>
										</div>
									</a>
								</div>
